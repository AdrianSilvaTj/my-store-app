...
export class ProductsListComponent {
  ...
  //productId, es un Input que va a recibir el parametro enviado por el query del url,
  // de esta manera realizamos una acción cuando esta variable cambia, sin tener que refrescar la pagina,
  // a diferencia de hacerlo en un ngOnInit:
